...
INSERT INTO dominios.tipo_elemento_energia (code,code_name, filter) VALUES (410,'Estação geradora – Termelétrica a carvão (410)','Estação geradora de energia');
INSERT INTO dominios.tipo_elemento_energia (code,code_name, filter) VALUES (411,'Estação geradora – Termelétrica a diesel (411)','Estação geradora de energia');
INSERT INTO dominios.tipo_elemento_energia (code,code_name, filter) VALUES (412,'Estação geradora – Termelétrica a gás (412)','Estação geradora de energia');
INSERT INTO dominios.tipo_elemento_energia (code,code_name, filter) VALUES (413,'Estação geradora – Termelétrica a biomassa (413)','Estação geradora de energia');
INSERT INTO dominios.tipo_elemento_energia (code,code_name, filter) VALUES (409,'Estação geradora – Termelétrica nuclear (409)','Estação geradora de energia');
INSERT INTO dominios.tipo_elemento_energia (code,code_name, filter) VALUES (497,'Estação geradora – Termelétrica outras (497)','Estação geradora de energia');
...
ALTER TABLE edgv.cobter_area_construida_a
	 ADD CONSTRAINT cobter_area_construida_a_tipo_check 
	 CHECK (tipo = ANY(ARRAY[1 :: SMALLINT, 2 :: SMALLINT, 3 :: SMALLINT, 4 :: SMALLINT, 5 :: SMALLINT, 6 :: SMALLINT, 7 :: SMALLINT, 97 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.constr_extracao_mineral_a
	 ...
	 CHECK (tipo = ANY(ARRAY[1 :: SMALLINT, 4 :: SMALLINT, 5 :: SMALLINT, 6 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.infra_trecho_duto_l
	 ADD CONSTRAINT infra_trecho_duto_l_situacao_fisica_check 
	 CHECK (situacao_fisica = ANY(ARRAY[1 :: SMALLINT, 2 :: SMALLINT, 3 :: SMALLINT, 4 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.infra_mobilidade_urbana_l
	 ADD CONSTRAINT infra_mobilidade_urbana_l_situacao_fisica_check 
	 CHECK (situacao_fisica = ANY(ARRAY[1 :: SMALLINT, 2 :: SMALLINT, 3 :: SMALLINT, 4 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.infra_elemento_energia_l
	 ADD CONSTRAINT infra_elemento_energia_l_situacao_fisica_check 
	 CHECK (situacao_fisica = ANY(ARRAY[1 :: SMALLINT, 2 :: SMALLINT, 3 :: SMALLINT, 4 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.infra_elemento_energia_p
	 ADD CONSTRAINT infra_elemento_energia_p_situacao_fisica_check 
	 CHECK (situacao_fisica = ANY(ARRAY[1 :: SMALLINT, 2 :: SMALLINT, 3 :: SMALLINT, 4 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.infra_elemento_energia_a
	 ADD CONSTRAINT infra_elemento_energia_a_situacao_fisica_check 
	 CHECK (situacao_fisica = ANY(ARRAY[1 :: SMALLINT, 2 :: SMALLINT, 3 :: SMALLINT, 4 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.aquisicao_centroide_area_construida_p
	 ADD CONSTRAINT aquisicao_centroide_area_construida_p_tipo_fk FOREIGN KEY (tipo)
	 REFERENCES dominios.tipo_localidade (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.aquisicao_centroide_area_construida_p
	 ADD CONSTRAINT aquisicao_centroide_area_construida_p_tipo_check 
	 CHECK (tipo = ANY(ARRAY[1 :: SMALLINT, 2 :: SMALLINT, 3 :: SMALLINT, 4 :: SMALLINT, 5 :: SMALLINT, 6 :: SMALLINT, 7 :: SMALLINT, 97 :: SMALLINT, 9999 :: SMALLINT])); 
ALTER TABLE edgv.aquisicao_centroide_area_construida_p ALTER COLUMN tipo SET DEFAULT 9999;
