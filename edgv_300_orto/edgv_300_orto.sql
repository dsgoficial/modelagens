...
CREATE TABLE public.db_metadata(
	 ...
	 dbimplversion varchar(50) NOT NULL DEFAULT '2.2.1',
	 CONSTRAINT edgvversioncheck CHECK (edgvversion = 'EDGV 3.0 Orto')
);
INSERT INTO public.db_metadata (edgvversion, dbimplversion) VALUES ('EDGV 3.0 Orto','2.2');
...
ALTER TABLE edgv.llp_aglomerado_rural_p
	 ADD CONSTRAINT llp_aglomerado_rural_p_simbolizar_carta_mini_fk FOREIGN KEY (simbolizar_carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.llp_aglomerado_rural_p ALTER COLUMN simbolizar_carta_mini SET DEFAULT 9999;
...
ALTER TABLE edgv.llp_unidade_conservacao_l
	 ADD CONSTRAINT llp_unidade_conservacao_l_tipo_check 
...
ALTER TABLE edgv.llp_unidade_conservacao_a
	 ...
	 CHECK (tipo = ANY(ARRAY[5 :: SMALLINT, 24 :: SMALLINT, 25 :: SMALLINT, 26 :: SMALLINT, 27 :: SMALLINT, 28 :: SMALLINT, 29 :: SMALLINT, 30 :: SMALLINT, 31 :: SMALLINT, 32 :: SMALLINT, 33 :: SMALLINT, 34 :: SMALLINT, 35 :: SMALLINT, 9999 :: SMALLINT, 9999 :: SMALLINT])); 
