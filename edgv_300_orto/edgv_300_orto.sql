...
INSERT INTO dominios.tipo_elemento_energia (code,code_name) VALUES (1801,'Subestação de transmissão/distribuição de energia elétrica (1801)');
...
ALTER TABLE edgv.infra_elemento_energia_p
	 ...
	 CHECK (tipo = ANY(ARRAY[1801 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.infra_ferrovia_l
	 ADD CONSTRAINT infra_ferrovia_l_carta_mini_fk FOREIGN KEY (carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.infra_ferrovia_l ALTER COLUMN carta_mini SET DEFAULT 9999;
...
ALTER TABLE edgv.infra_via_deslocamento_l
	 ADD CONSTRAINT infra_via_deslocamento_l_carta_mini_fk FOREIGN KEY (carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.infra_via_deslocamento_l ALTER COLUMN carta_mini SET DEFAULT 9999;
...
ALTER TABLE edgv.edicao_identificador_trecho_rod_p
	 ADD CONSTRAINT edicao_identificador_trecho_rod_p_carta_mini_fk FOREIGN KEY (carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.edicao_identificador_trecho_rod_p ALTER COLUMN carta_mini SET DEFAULT 9999;
...
CREATE TABLE edgv.edicao_simb_cota_mestra_p(
	 id uuid NOT NULL DEFAULT uuid_generate_v4(),
	 observacao VARCHAR(255),
	 geom geometry(MultiPoint, 4674),
	 CONSTRAINT edicao_simb_cota_mestra_p_pk PRIMARY KEY (id)
	 WITH (FILLFACTOR = 80)
);
CREATE INDEX edicao_simb_cota_mestra_p_geom ON edgv.edicao_simb_cota_mestra_p USING gist (geom);

ALTER TABLE edgv.edicao_simb_cota_mestra_p OWNER TO postgres;
...
ALTER TABLE edgv.edicao_texto_generico_p
	 ADD CONSTRAINT edicao_texto_generico_p_carta_mini_fk FOREIGN KEY (carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.edicao_texto_generico_p ALTER COLUMN carta_mini SET DEFAULT 9999;
...
ALTER TABLE edgv.edicao_texto_generico_l
	 ADD CONSTRAINT edicao_texto_generico_l_carta_mini_fk FOREIGN KEY (carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.edicao_texto_generico_l ALTER COLUMN carta_mini SET DEFAULT 9999;
