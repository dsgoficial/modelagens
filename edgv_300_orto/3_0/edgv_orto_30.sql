...
CREATE TABLE public.db_metadata(
	 edgvversion varchar(50) NOT NULL DEFAULT 'EDGV Orto 3.0',
	 dbimplversion varchar(50) NOT NULL DEFAULT '3.0.0',
	 CONSTRAINT edgvversioncheck CHECK (edgvversion = 'EDGV Orto 3.0')
);
