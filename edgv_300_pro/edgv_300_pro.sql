...
INSERT INTO dominios.tipo_ocupacao_solo (code,code_name, filter) VALUES (1701,'Subestação de transmissão/distribuição de energia elétrica (1701)','Subestação de energia');
