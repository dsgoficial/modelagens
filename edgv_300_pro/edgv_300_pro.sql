...
CREATE TABLE public.db_metadata(
	 ...
	 dbimplversion varchar(50) NOT NULL DEFAULT '1.2.2',
	 CONSTRAINT edgvversioncheck CHECK (edgvversion = 'EDGV 3.0 Pro')
);
INSERT INTO public.db_metadata (edgvversion, dbimplversion) VALUES ('EDGV 3.0 Pro','1.2.2');
...
ALTER TABLE edgv.llp_localidade_p
	 ADD CONSTRAINT llp_localidade_p_simbolizar_carta_mini_fk FOREIGN KEY (simbolizar_carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.llp_localidade_p ALTER COLUMN simbolizar_carta_mini SET DEFAULT 9999;
...
ALTER TABLE edgv.edicao_area_sem_dados_a
	 ADD CONSTRAINT edicao_area_sem_dados_a_rotular_carta_mini_fk FOREIGN KEY (rotular_carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.edicao_area_sem_dados_a ALTER COLUMN rotular_carta_mini SET DEFAULT 9999;
...
ALTER TABLE edgv.centroide_area_sem_dados_p
	 ADD CONSTRAINT centroide_area_sem_dados_p_justificativa_txt_fk FOREIGN KEY (justificativa_txt)
	 REFERENCES dominios.justificativa (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.centroide_area_sem_dados_p ALTER COLUMN justificativa_txt SET DEFAULT 9999;

ALTER TABLE edgv.centroide_area_sem_dados_p
	 ADD CONSTRAINT centroide_area_sem_dados_p_rotular_carta_mini_fk FOREIGN KEY (rotular_carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.centroide_area_sem_dados_p ALTER COLUMN rotular_carta_mini SET DEFAULT 9999;
...
CREATE TABLE edgv.aux_grid_revisao_a(
	 id uuid NOT NULL DEFAULT uuid_generate_v4(),
	 rank integer,
	 visited boolean,
...
CREATE INDEX aux_grid_revisao_a_geom ON edgv.aux_grid_revisao_a USING gist (geom);

ALTER TABLE edgv.aux_grid_revisao_a OWNER TO postgres;
