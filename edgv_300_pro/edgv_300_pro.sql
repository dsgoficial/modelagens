...
INSERT INTO public.db_metadata (edgvversion, dbimplversion) VALUES ('EDGV 3.0 Pro','1.1');
...
ALTER TABLE edgv.infra_trecho_hidroviario_l
	 ADD CONSTRAINT infra_trecho_hidroviario_l_justificativa_txt_fk FOREIGN KEY (justificativa_txt)
	 REFERENCES dominios.justificativa (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.infra_trecho_hidroviario_l ALTER COLUMN justificativa_txt SET DEFAULT 9999;
...
ALTER TABLE edgv.infra_elemento_energia_p
	 ...
	 CHECK (tipo = ANY(ARRAY[601 :: SMALLINT, 1401 :: SMALLINT, 1701 :: SMALLINT, 405 :: SMALLINT, 406 :: SMALLINT, 407 :: SMALLINT, 408 :: SMALLINT, 409 :: SMALLINT, 498 :: SMALLINT, 1801 :: SMALLINT, 1802 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.infra_elemento_energia_l
	 ...
	 CHECK (tipo = ANY(ARRAY[302 :: SMALLINT, 303 :: SMALLINT, 601 :: SMALLINT, 405 :: SMALLINT, 406 :: SMALLINT, 407 :: SMALLINT, 408 :: SMALLINT, 409 :: SMALLINT, 498 :: SMALLINT, 1801 :: SMALLINT, 1802 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.infra_elemento_energia_a
	 ...
	 CHECK (tipo = ANY(ARRAY[601 :: SMALLINT, 405 :: SMALLINT, 406 :: SMALLINT, 407 :: SMALLINT, 408 :: SMALLINT, 409 :: SMALLINT, 498 :: SMALLINT, 1801 :: SMALLINT, 1802 :: SMALLINT, 9999 :: SMALLINT])); 
...
ALTER TABLE edgv.llp_limite_especial_l
	 ADD CONSTRAINT llp_limite_especial_l_sobreposto_fk FOREIGN KEY (sobreposto)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.llp_limite_especial_l ALTER COLUMN sobreposto SET DEFAULT 9999;

ALTER TABLE edgv.llp_limite_especial_l
	 ADD CONSTRAINT llp_limite_especial_l_exibir_rotulo_aproximado_fk FOREIGN KEY (exibir_rotulo_aproximado)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.llp_limite_especial_l ALTER COLUMN exibir_rotulo_aproximado SET DEFAULT 9999;
...
ALTER TABLE edgv.llp_limite_especial_a
	 ADD CONSTRAINT llp_limite_especial_a_rotular_carta_mini_fk FOREIGN KEY (rotular_carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.llp_limite_especial_a ALTER COLUMN rotular_carta_mini SET DEFAULT 9999;
...
ALTER TABLE edgv.llp_limite_legal_a
	 ADD CONSTRAINT llp_limite_legal_a_justificativa_txt_fk FOREIGN KEY (justificativa_txt)
	 REFERENCES dominios.justificativa (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.llp_limite_legal_a ALTER COLUMN justificativa_txt SET DEFAULT 9999;

ALTER TABLE edgv.llp_limite_legal_a
	 ADD CONSTRAINT llp_limite_legal_a_rotular_carta_mini_fk FOREIGN KEY (rotular_carta_mini)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.llp_limite_legal_a ALTER COLUMN rotular_carta_mini SET DEFAULT 9999;
...
CREATE TABLE edgv.aquisicao_centroide_area_nao_mapeada_p(
	 id uuid NOT NULL DEFAULT uuid_generate_v4(),
	 observacao varchar(255),
	 geom geometry(MultiPoint, 4674),
	 CONSTRAINT aquisicao_centroide_area_nao_mapeada_p_pk PRIMARY KEY (id)
	 WITH (FILLFACTOR = 80)
);
CREATE INDEX aquisicao_centroide_area_nao_mapeada_p_geom ON edgv.aquisicao_centroide_area_nao_mapeada_p USING gist (geom);

ALTER TABLE edgv.aquisicao_centroide_area_nao_mapeada_p OWNER TO postgres;
...
CREATE TABLE edgv.aquisicao_limite_limite_especial_l(
	 id uuid NOT NULL DEFAULT uuid_generate_v4(),
	 observacao varchar(255),
	 geom geometry(MultiLinestring, 4674),
	 CONSTRAINT aquisicao_limite_limite_especial_l_pk PRIMARY KEY (id)
	 WITH (FILLFACTOR = 80)
);
CREATE INDEX aquisicao_limite_limite_especial_l_geom ON edgv.aquisicao_limite_limite_especial_l USING gist (geom);

ALTER TABLE edgv.aquisicao_limite_limite_especial_l OWNER TO postgres;
...
ALTER TABLE edgv.aquisicao_centroide_vegetacao_p ALTER COLUMN sujeito_inundacao SET DEFAULT 9999;
...
ALTER TABLE edgv.aquisicao_centroide_area_construida_p
	 ADD CONSTRAINT aquisicao_centroide_area_construida_p_assentamento_precario_fk FOREIGN KEY (assentamento_precario)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.aquisicao_centroide_area_construida_p ALTER COLUMN assentamento_precario SET DEFAULT 9999;

CREATE TABLE edgv.aux_identificacao_antropizacao_a(
	 id uuid NOT NULL DEFAULT uuid_generate_v4(),
	 descricao varchar(255),
	 observacao varchar(255),
	 geom geometry(MultiPolygon, 4674),
	 CONSTRAINT aux_identificacao_antropizacao_a_pk PRIMARY KEY (id)
	 WITH (FILLFACTOR = 80)
);
CREATE INDEX aux_identificacao_antropizacao_a_geom ON edgv.aux_identificacao_antropizacao_a USING gist (geom);

ALTER TABLE edgv.aux_identificacao_antropizacao_a OWNER TO postgres;
...
CREATE TABLE edgv.aquisicao_centroide_limite_especial_p(
	 id uuid NOT NULL DEFAULT uuid_generate_v4(),
	 nome varchar(255),
	 tipo smallint NOT NULL,
	 geometria_aproximada smallint NOT NULL,
	 observacao varchar(255),
	 geom geometry(MultiPoint, 4674),
	 CONSTRAINT aquisicao_centroide_limite_especial_p_pk PRIMARY KEY (id)
	 WITH (FILLFACTOR = 80)
);
CREATE INDEX aquisicao_centroide_limite_especial_p_geom ON edgv.aquisicao_centroide_limite_especial_p USING gist (geom);

ALTER TABLE edgv.aquisicao_centroide_limite_especial_p OWNER TO postgres;

ALTER TABLE edgv.aquisicao_centroide_limite_especial_p
	 ADD CONSTRAINT aquisicao_centroide_limite_especial_p_tipo_fk FOREIGN KEY (tipo)
	 REFERENCES dominios.tipo_limite_especial (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.aquisicao_centroide_limite_especial_p ALTER COLUMN tipo SET DEFAULT 9999;

ALTER TABLE edgv.aquisicao_centroide_limite_especial_p
	 ADD CONSTRAINT aquisicao_centroide_limite_especial_p_geometria_aproximada_fk FOREIGN KEY (geometria_aproximada)
	 REFERENCES dominios.booleano (code) MATCH FULL
	 ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE edgv.aquisicao_centroide_limite_especial_p ALTER COLUMN geometria_aproximada SET DEFAULT 9999;
